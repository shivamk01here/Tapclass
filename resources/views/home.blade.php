...
@section('content')
    ...
    <section class="py-12">
        <div class="max-w-7xl mx-auto px-4">
            <div class="bg-black text-white border-2 border-black rounded-2xl shadow-header-chunky p-8 md:p-12 relative overflow-hidden">
                <div class="absolute inset-0 opacity-20 bg-[url('https://www.transparenttextures.com/patterns/cubes.png')]"></div>
                
                <div class="flex flex-col md:flex-row items-center justify-between gap-8 relative z-10">
                    <div class="flex-1 text-center md:text-left">
                        <span class="inline-block bg-red-500 text-white text-xs font-bold uppercase tracking-wider px-2 py-1 rounded-sm mb-4">New Feature</span>
                        ...
                        <p class="text-gray-300 text-lg max-w-xl mb-8">Pinpoint your weak areas before the real exam does.</p>
                    ...
                    <div class="flex-1 flex justify-center md:justify-end">
                        <img src="{{ asset('images/homepage/Chat bot-bro.svg') }}" alt="AI Exam Prep" class="w-full h-auto max-w-md drop-shadow-2xl">
                    </div>
                </div>
            </div>
        </div>
