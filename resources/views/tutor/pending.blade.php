...
<div class="max-w-2xl mx-auto" data-aos="fade-up">
  <div class="bg-white rounded-2xl border border-gray-100 p-8 shadow">
    <h1 class="text-3xl font-black text-gray-900 mb-2">Welcome to Htc!</h1>
    ...
    <div class="space-y-4">
      <div class="flex items-center gap-4 p-5 bg-blue-50 border border-blue-200 rounded-lg">
        ...
        <div>
          <h3 class="font-bold text-lg text-gray-900">Verification Status: {{ ucfirst($profile->verification_status) }}</h3>
